...
const int PIN_CONE_MOTOR_IN2 = 32;
const int PIN_CONE_MOTOR_IN1 = 34;
const int PIN_CONE_MOTOR_EN = 36;

const int PIN_GRND_MOTOR_EN = 26;
const int PIN_GRND_MOTOR_IN1 = 30;
const int PIN_GRND_MOTOR_IN2 = 28;
...
SerialBroadcast serialBroadcast2(&Serial2,115200,false);
...
////STGR EXECUTOR ROUTINE   /////////////////
  ...
  if (GRND.nextStepNumber != GRND.isStepNumber) {
   ...
   if(GRND_scale.scaleFlag){
      Serial.println("Weight:   " + String(scaleWeight) + "g");
   }
   }
